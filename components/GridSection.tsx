...
const defaultAssets: MediaAsset[] = [
  ...
  { url: '/images/grid/4.png', alt: 'Custom Home Visualization' },
  { url: '/images/grid/5.png', alt: 'Smart Cost Advantages' },
...
export default function GridSection({ gridSection }: Props) {
  ...
  const itemTitles = [
    ...
    gridSection?.item4?.title || 'Custom Home Visualization',
    gridSection?.item5?.title || 'Smart Cost Advantages',
